...
import { User, INITIAL_ACHIEVEMENTS } from '../types';
import { saveUserToDb, logToAudit } from '../utils/storage';
...
const SignupPage: React.FC<Props> = ({ onSignup, onNavigate }) => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(async () => {
      ...
      await logToAudit(username, email, 'SIGNUP');
      onSignup(newUser);
      setLoading(false);
    }, 1000);
  };
